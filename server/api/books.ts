  ...
  return [
    {
      ...
      cover: "https://covers.openlibrary.org/b/id/10249340-L.jpg",
    },
    {
      key: "2",
      count: 1,
      ...
      cover: "https://covers.openlibrary.org/b/id/10838415-L.jpg",
      author: {
        name: "Габриэль Гарсиа Маркес",
        bio: "Габриэль Гарсиа Маркес – колумбийский прозаик, журналист и издатель, представитель магического реализма, лауреат Нейштадтской литературной премии, обладатель Нобелевской премии по литературе (1982), премии Ромуло Гальегоса, мексиканского Ордена Ацтекского орла и российского Ордена Почета за вклад в укрепление дружбы между народами Российской Федерации и Латинской Америки.\r\n\r\n Габриэль Хосе де ла Конкордиа «Габо» Гарсиа Маркес появился на свет 6 марта 1927 года в колумбийском городке Аракатаке в семье фармацевта. Но через два года ребенку пришлось разлучиться с родителями, переехавшими в другой город, и его продолжили воспитывать бабушка и дедушка по матери. Именно они и познакомили будущего писателя с народными преданиями и языковыми особенностями, ставшими впоследствии важным элементом его творчества.\r\n\r\n После смерти деда Габриэль в возрасте девяти лет воссоединился с родителями и стал жить в Сукре. К тринадцати годам он уже обладал стипендией на обучение в иезуитском колледже Сипакиры. А в 1946 году, исполнив волю родителей, стал студентом юридического факультета Национального университета Боготы. Но не доучился: попрощавшись с престижным образованием в 1950 году, он начал журналистскую и литературную деятельность.",
      },
    },
    {
      key: "3",
    ...
    },
    {
      ...
      cover: "https://covers.openlibrary.org/b/id/11428531-L.jpg",
      description:
        "«Повели́тель мух» (англ. Lord of the Flies) — дебютный аллегорический роман с элементами антиутопии английского писателя, лауреата Нобелевской премии по литературе (1983), Уильяма Голдинга, вышедший в 1954 году. Роман воспитания Уильяма Голдинга был задуман первоначально в качестве иронического комментария к популярному в 19 веке роману «Коралловый остров» Баллантайна. В СССР на русском языке роман «Повелитель мух» был впервые опубликован в 1969 году в пяти номерах журнала «Вокруг света» в переводе Владимира Тельникова. Этот перевод больше не издавался, а отдельной книгой роман начал издаваться только с 1981 года в переводе Елены Суриц.",
    },
  ];
});
